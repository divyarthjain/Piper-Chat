          ...
          return (
            <div 
              ...
              className={`transition-all duration-1000 ${
                highlightedMessageId === msg.id ? 'bg-white/10 -mx-4 px-4 py-2' : ''
              }`}
            >
              <Message 
                message={msg} 
              ...
              {replies.length > 0 && (
                <div className="ml-12 mt-1">
                  <button 
                    ...
                    className="flex items-center gap-1 text-xs text-violet-400 hover:text-violet-300 transition-colors mb-2"
                  >
                    ...
                    <div className="space-y-2 border-l-2 border-white/10 pl-4 py-1">
                      {replies.map(reply => (
                        <div 
                          ...
                          className={highlightedMessageId === reply.id ? 'bg-white/10 -mx-4 px-4 py-2' : ''}
                        >
                          <Message 
                            message={reply} 
